document.querySelectorAll('.logoutButton').forEach(button => {
    ...
    document.querySelectorAll('.logoutLink').forEach(link => {
        ...
        // Agregar escuchador de clic al enlace
        link.addEventListener('click', (event) => {
            event.preventDefault(); // Evitar que el enlace se siga automáticamente
    
            let button = event.target.closest('.logoutLink'); // Obtener el botón más cercano al enlace
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                ...
                                setTimeout(() => {
                                    ...
                                    // Una vez completada la animación, redirigir al enlace
